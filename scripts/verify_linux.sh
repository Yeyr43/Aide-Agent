#!/usr/bin/env bash
# Linux 平台验证脚本 — 运行所有关键检查
set -e

echo "=== Aide Agent — Linux 平台验证 ==="
echo ""
...
python3 -c "from ui.textual_app.platform import IS_LINUX, can_use_tray; print(f'Linux: {IS_LINUX}, Tray: {can_use_tray()}')"
