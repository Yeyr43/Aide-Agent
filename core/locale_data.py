"""Aide 双语字符串数据 — 从 locale.py 拆分出纯数据层。

所有 UI 字符串集中在此处，通过 locale.py 的 t() 函数访问。
不要在业务代码中直接导入此模块。
"""
...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "ui.api.error_required": {
        "zh": "⚠️ 名称、Provider、Model 为必填项",
        "en": "⚠ Name, Provider, and Model are required",
    },
    "ui.api.error_duplicate": {
        "zh": "⚠️ API 名称 **{name}** 已被占用，请换一个",
        "en": "⚠ API name **{name}** is already taken, please use another",
    },
